...
public sealed class SetAvitoFiltersBehavior(WebElement Element, string[] filters)
    : IWebDriverBehavior
{
...
public sealed class ClickOnCheckBoxesWithEnsureClicked(WebElement element) : IWebDriverBehavior
{
