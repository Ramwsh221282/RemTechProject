...
using SharedParsersLibrary.Puppeteer.PageCreation;

namespace SharedParsersLibrary.Puppeteer.Extensions;
...
public static class BrowserExtensions
{
    ...
    private static PageFactory CreateFactoryByStrategy(this IPageCreationStrategy strategy) =>
        new(strategy);
